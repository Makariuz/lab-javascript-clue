...
function selectRandom(arr) {
  let susp = arr[Math.floor(Math.random() * arr.length)]
  return susp
}
...
//on my codepen where i tested this with a console log in revealmystery, it worked as it should, but there is still an error
